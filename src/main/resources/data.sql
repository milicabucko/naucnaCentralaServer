...
INSERT INTO `izdanje_magazina` (`id`,`cena`,`magazin_id`,`mesec`) VALUES (1,0,1,'Januar');
INSERT INTO `izdanje_magazina` (`id`,`cena`,`magazin_id`,`mesec`) VALUES (2,200,1,'Februar');
INSERT INTO `izdanje_magazina` (`id`,`cena`,`magazin_id`,`mesec`) VALUES (3,200,1,'Mart');
INSERT INTO `izdanje_magazina` (`id`,`cena`,`magazin_id`,`mesec`) VALUES (4,450,2,'Januar');
...
INSERT INTO `naucni_rad` (`id`,`cena`,`izdanje_magazina_id`,`kljucni_pojmovi`,`koautori`,`link`,`magazin_id`,`naucna_oblast`,`prihvacen`) VALUES (1,100,4,'a','a',NULL,2,'a',1);
INSERT INTO `naucni_rad` (`id`,`cena`,`izdanje_magazina_id`,`kljucni_pojmovi`,`koautori`,`link`,`magazin_id`,`naucna_oblast`,`prihvacen`) VALUES (2,100,4,'l','l',NULL,2,'a',0);
